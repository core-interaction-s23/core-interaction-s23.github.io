...
- Then I’m going to meet with you individually. We will have about 10 minutes, each. (I am going to set a timer, to keep roughly on track.) When it is your turn, please come up to the front. Spend a minute or two telling me about your story, interpretation, and concept. Then let’s look at your in-progress work (send your URL in the lab channel)—and go through your questions. Let’s focus on the code, but we can dip into Figma if needed. In no particular order:
